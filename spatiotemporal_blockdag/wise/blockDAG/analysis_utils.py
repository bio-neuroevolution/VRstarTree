...
def __to_Cartesian_rect(p1, p2,extends=None):
    p1 = to_Cartesian(*p1)
    p2 = to_Cartesian(*p2)
    if extends is None:
        return (min(p1[0], p2[0]), min(p1[1], p2[1]), min(p1[2], p2[2])), (max(p1[0], p2[0]), max(p1[1], p2[1]), max(p1[2], p2[2]))
    else:
        return (min(p1[0], p2[0]), min(p1[1], p2[1]), min(extends[0],extends[1])), (max(p1[0], p2[0]), max(p1[1], p2[1]), max(extends[0],extends[1]))
